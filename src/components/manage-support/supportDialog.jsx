        ...
        <Spin spinning={loading}>
          <Form form={form} onFinish={replySupportRequest}>
            <Form.Item label={<label className="text-gray-800 font-semibold">Issue subject</label>}>
              <p>{detailRequest?.subject || 'No subject provided'}</p>
            </Form.Item>
            ...
            <Form.Item
              label={<label className="text-gray-800 font-semibold">Issue description</label>}
            >
            ...
            <Form.Item
              name="reply"
              label={<label className="text-gray-800 font-semibold">Reply</label>}
            >
              {detailRequest?.isReplied ? (
                <p>{detailRequest?.adminResponse}</p>
              ) : (
                <TextArea rows={7} />
              )}
            </Form.Item>
