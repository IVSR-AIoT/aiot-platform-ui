...
export default function Card({ data, getProjectData, setOpenDialog }) {
    const handleOpenDialog = () => {
        getProjectData(data);
        setOpenDialog(true); // Open the dialog for both admins and regular users
    };
            ...
            <div className="flex justify-between h-[40px] border-b-2">
                ...
                {isAdmin() ? (
                    ...
                    <button
                        ...
                        onClick={handleOpenDialog} // Use the same function for regular users
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
