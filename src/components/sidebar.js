                    ...
                    <ul class="space-y-2 font-medium">
                        <li className="flex justify-between">
                            ...
                            <svg
                                ...
                                stroke-width="1.5"
                                stroke="currentColor"
                                class="size-6  text-gray-500 transition duration-75 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
                            >
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Navigator</span>
                                <svg
                                    class="w-3 h-3"
                                    aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg"
