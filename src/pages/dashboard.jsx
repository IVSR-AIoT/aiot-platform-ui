import { Button, Card, DatePicker, Input, message, Pagination, Segmented, Select } from 'antd';
...
function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-[#F0F2F5] p-5">
            ...
            />
            <Pagination align="center" defaultCurrent={1} total={50} onChange={(value) => setPagination(value)} />
        </div>
    );
}
