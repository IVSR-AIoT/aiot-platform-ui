...
function Register() {
    ...
    return (
        <div>
            {loading ? (
                <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 absolute top-0 right-0" role="alert">
                <span class="font-medium">Register successfully!</span> Waitting ...
              </div>
            ) : (
                <div>
                    {isVisible && (
